            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.nav_home:
                        ...
                        myIntent = new Intent(PreviousOrders.this, HomeActivity.class);
                    ...
                    case R.id.nav_profile:
                        ...
                        drawerLayout.closeDrawer(GravityCompat.START);
                        myIntent = new Intent(PreviousOrders.this, ProfileUser.class);
                        myIntent.putExtra("name",user_name);
                        myIntent.putExtra("email",user_email);
                        myIntent.putExtra("age",user_age);
                        myIntent.putExtra("address",user_address);
                    ...
                    case R.id.nav_FAQ:
                        ...
                        drawerLayout.closeDrawer(GravityCompat.START);
                        myIntent = new Intent(PreviousOrders.this, faq.class);
                        myIntent.putExtra("name",user_name);
                        myIntent.putExtra("email",user_email);
                        myIntent.putExtra("age",user_age);
                        myIntent.putExtra("address",user_address);
                    ...
                    case R.id.nav_signout:
                        ...
                        drawerLayout.closeDrawer(GravityCompat.START);
                        myIntent = new Intent(PreviousOrders.this, loginpage.class);
                        startActivity(myIntent);
                        finish();
                        break;
                }
